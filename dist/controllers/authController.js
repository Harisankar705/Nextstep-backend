    ...
    constructor(authService, otpServiceInstance) {
        ...
        this.requestPasswordReset = async (req, res, next) => {
            try {
                ...
                const dto = await (0, validateDTO_1.validateDTO)(userDTO_1.RequestPasswordResetDTO, req.body);
        ...
        this.resetPassword = async (req, res, next) => {
            try {
                const dto = await (0, validateDTO_1.validateDTO)(userDTO_1.ResetPasswordDTO, req.body);
        ...
        this.googleLogin = async (req, res, next) => {
            try {
                ...
                if (!token || !role) {
                    res.status(statusCode_1.STATUS_CODES.NOT_FOUND).json({ success: false, message: "Token and role required!" });
                    return;
                }
