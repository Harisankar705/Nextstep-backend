...
const connectionSchema = new mongoose_1.Schema({
    followerId: { type: mongoose_1.default.Schema.ObjectId, ref: "User", required: true },
    followingId: { type: mongoose_1.default.Schema.ObjectId, ref: "User", required: true },
    isFollowBack: { type: Boolean, default: false },
    createdAt: { type: Date, default: Date.now },
    updatedAt: { type: Date, default: Date.now },
    status: { type: String, enum: authTypes_1.ConnectionStatus, required: true }
});
